...
library(foreach)
            ...
            # reorder the cell label
            prop_stats$SAMPLE <- factor(prop_stats$SAMPLE, levels = rev(c("EFEs","CTRLs","Fetals","Youngs")))
            prop_stats$Cell_Type <- factor(prop_stats$Cell_Type, levels = c("EC_1","EC_2","EC_3","EndoC","FB","SMC","CM","Macrophage", "T-cell","PeriC","Neuro","Mast-cell"))
            ...
            only_EC = subset(comb_s, subset = Cell_Type %in% c("EC_1","EC_2","EC_3"))
            ...
            data_pair = melt_pair[(variable == "EC_1" & SAMPLE == "CTRLs") | (variable == "EC_1" & SAMPLE == "EFEs") | (variable == "EC_2" & SAMPLE == "EFEs") | (variable == "EC_3" & SAMPLE == "EFEs")]
            data_pair[variable == "EC_1" & SAMPLE == "CTRLs", variable := "EC1_CTRLs"][variable == "EC_1" & SAMPLE == "EFEs", variable := "EC1_EFEs"][variable == "EC_2" & SAMPLE == "EFEs", variable := "EC_2"][variable == "EC_3" & SAMPLE == "EFEs", variable := "EC_3"] 
            data_pair$variable <- factor(data_pair$variable, levels = c("EC1_CTRLs","EC1_EFEs","EC_2","EC_3"))
            ...
            # plots
            data_pair = melt_pair[(variable == "EC_1" & SAMPLE == "CTRLs") | (variable == "EC_1" & SAMPLE == "EFEs") | (variable == "EC_2" & SAMPLE == "EFEs") | (variable == "EC_3" & SAMPLE == "EFEs")]
            data_pair[variable == "EC_1" & SAMPLE == "CTRLs", variable := "EC1_CTRLs"][variable == "EC_1" & SAMPLE == "EFEs", variable := "EC1_EFEs"][variable == "EC_2", variable := "EC_2"][variable == "EC_3", variable := "EC_3"]
            data_pair$variable <- factor(data_pair$variable, levels = c("EC1_CTRLs","EC1_EFEs","EC_2","EC_3"))
            ...
            # plots
            data_pair = endo_MT[(Cell_Type == "EC_1") | (Cell_Type == "EC_2" & SAMPLE == "EFEs") | (Cell_Type == "EC_3" & SAMPLE == "EFEs")]
            data_pair[Cell_Type == "EC_1" & SAMPLE == "CTRLs", Cell_Type := "EC1_CTRLs"][Cell_Type == "EC_1" & SAMPLE == "EFEs", Cell_Type := "EC1_EFEs"][Cell_Type == "EC_2", Cell_Type := "EC_2"][Cell_Type == "EC_3", Cell_Type := "EC_3"]
            data_pair$Cell_Type <- factor(data_pair$Cell_Type, levels = c("EC1_CTRLs","EC1_EFEs","EC_2","EC_3"))
            ...
            ECDEGs = gene_expr[cell_type == "EC_1"][padj < 0.05][log2FoldChange > 0.58]
            e1e3 = ct_intmkr[cluster %in% c("EC_2","EC_3")][p_val_adj < 0.05]
            
            library(clusterProfiler)
            library(org.Hs.eg.db)
            
            ece1_go <- enrichGO(gene    = e1e3[cluster == "EC_2"]$gene,
                                OrgDb    = org.Hs.eg.db,
                                keyType  = 'SYMBOL',
                                ont      = "CC",
                                pAdjustMethod = "BH",
            ...
            ece3_go <- enrichGO(gene    = e1e3[cluster == "EC_3"]$gene,
                                OrgDb    = org.Hs.eg.db,
                                keyType  = 'SYMBOL',
                                ont      = "CC",
                                pAdjustMethod = "BH",
            ...
            go = rbind(ece1_go[grepl("collagen|signaling|proliferation|actin",Description)][, group := "EC_2"], ece3_go[grepl("collagen|signaling|proliferation|actin",Description)][, group := "EC_3"], ec_go[grepl("collagen|signaling|proliferation|actin",Description)][, group := "EC_1"])
            ...
            ggplot(go[`-log10(P-value)` > 3], aes(x = `-log10(P-value)`, y = reorder(Term, `-log10(P-value)`))) + 
              ...
              scale_color_manual(name = "Cell type",values = c("EC_1" = "#FC8D62","EC_2" = "#00BFFF", "EC_3" = "#DDA0DD")) +
            ...
            selected_cell_types = c("EC_1","EC_2","CM")
            ...
            avg_expr_z_ordered <- avg_expr_z[, c("EC_1","EC_2","CM")]
            ...
            # Subset the Seurat object for selected cell types
            selected_cell_types = c("EC_1","EC_3","FB")
            ...
            avg_expr_z_ordered <- avg_expr_z[, c("EC_1","EC_3","FB")]
            ...
            # Fig.K
            # load processed
            GO_1 = fread("/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/DE/Enrichr_ec13markers/EC_2_GO_Biological_Process_padj.txt")
            GO_3 = fread("/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/DE/Enrichr_ec13markers/EC_3_GO_Biological_Process_padj.txt")
            ...
            GO = rbind(GO_1[, group := "EC_2"][1:5,][,class:="Top enriched"],GO_1[grepl("Contr|Muscle|Imp|Stress|Cardi|Heart",Term)][`P-value` < 0.05][c(1,2,4,6),][,class:="CM related func."])
            ...
            ggplot(GO, aes(x = `-log10(P-value)`, y = reorder(Term, `-log10(P-value)`))) +
              ...
              scale_color_manual(name = "Cell type",values = c("EC_2" = "#00BFFF", "EC_3" = "#DDA0DD")) +
              labs(x = "-log10 (P-value)",y = NULL) +
            ...
            GO = rbind(GO_3[, group := "EC_3"][1:5,][,class:="Top enriched"],GO_3[grepl("Contr|Muscle|Imp|Stress|Cardi|Heart",Term)][`P-value` < 0.05][c(1,3,9,14),][,class:="Mesc. related func."])
            ...
            # Fig.P
            EC_2_lisa = fread("/Users/yangyu/Desktop/Harvard_ChenLab/EP/slides/Paper/Circulation/revision/data/RevisionMinors_022326/data_results/data_IKMPresults/EC_E1_lisa_022926.csv")
            EC_3_lisa = fread("/Users/yangyu/Desktop/Harvard_ChenLab/EP/slides/Paper/Circulation/revision/data/RevisionMinors_022326/data_results/data_IKMPresults/EC_E3_lisa_022926.csv")
            ...
            setnames(EC_2_lisa, c("TF","rank","P","p2","p3","p4","p5"))
            setnames(EC_3_lisa, c("TF","rank","P","p2","p3","p4","p5"))
            setnames(EC_lisa, c("TF","rank","P","p2","p3","p4","p5"))
            
            lisa = rbind(EC_2_lisa[1:30,][,group:="EC_2_marker"],EC_3_lisa[1:30,][,group:="EC_3_marker"],EC_lisa[1:30,][,group:="EC1_DE"])
            
            common_TFs <- lisa[group %in% c("EC_2_marker", "EC_3_marker", "EC1_DE"), .N, by = TF][N == 3, TF]
            ...
            paper.atac = subset(combined.atac, Cell_Type %in% c("EC_1","EC_2","EC_3"))
            ...
            ggplot(smoothed_data[smoothed_data$Cell_Type %in% c("EC_1") | (smoothed_data$SAMPLE == "EFEs" & smoothed_data$Cell_Type %in% c("EC_2", "EC_3")), ], aes(x = x, y = y_smooth, color = SAMPLE)) +
            ...
            prop_stats$largest_col <- factor(prop_stats$largest_col, levels = c("EC_2","EC_3", "EC_1","CM","FB","SMC","EndoC"))
            
            
            # plot
            prop_stats$largest_col <- factor(prop_stats$largest_col, levels = c("EC_3", "EC_2", "EC_1","CM","EndoC", "FB","SMC"))
            ...
            key_matc = data.table(V1 = c(0:11), pred_celltype = c("CM","EC_1","EC_2","EC_3","EndoC","FB","Macrophage","Mast-cell","Neuro","PeriC","SMC","T-cell"))
            ...
            enrichment = foreach(fl = unique(files$files),.combine = "rbind")%do%{
              ...
              setnames(tmps, c("V1","CM","EC_1","EC_2","EC_3","EndoC","FB","Macrophage","Mast-cell","Neuro","PeriC","SMC","T-cell"))
            ...
            # pvalue matrix
            pval_matrix = dcast(enrichment[grepl("EFEs",SAMPLE)], pred_celltype ~ variable, value.var = "pvalue", fun.aggregate = mean) # p
            ...
            row_order <- c("EC_1","EC_2","EC_3","EndoC","T-cell","FB","Macrophage","Mast-cell","PeriC","Neuro","SMC","CM")  # Replace with your desired row order
            col_order <- c("EC_1","EC_2","EC_3","EndoC","T-cell","FB","Macrophage","Mast-cell","PeriC","Neuro","SMC","CM")  # Replace with your desired column order
