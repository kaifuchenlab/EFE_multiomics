...
#setseed(1234)
            ...
            #### subset RNA min count >500 in multiomics sample
            EFE001 <- subset(
              x = EFE001,
            ...
            EC_addi=c("PECAM1","EGFL7","MECOM") #~ #Cdh5, Pecam1 EC=c("PECAM1","VWF","SMOC1","CD36","MEOX2","TCF15","FABP4") # Meox2/Tcf15, Fabp4, and Cd36
            #EC_addi=c("PECAM1","VWF","CDH5","CD36","CD31","CD34","CD93","EGFL7","ID3","FLT1","GNG11","MCAM","FLT4","PLVAP","ADGRF5","ABCG2","MECOM","ETV2")
            #FeaturePlot(combined,reduction = "umap",features = EC_addi,split.by = "orig.ident",pt.size = 0.0001)
            #VlnPlot(combined,features =EC_addi,pt.size = 0,ncol = 2)
            
            
            
            EC_Card=c("LINGO1","BCOR","MYH11","ABLIM3") # identified by FindAllMarkers
            ...
            C6="Fibroblast"  #                    
            C7="EC"  #                      
            C8="EC-Card"  # UMAP close to CM and EC           
            C9="Macrophage"    #      
            C10="Cardiomyocyte" #                      
            C11="SMC"  #!             
