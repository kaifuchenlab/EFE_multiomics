...
#setseed(1234)
            ...
            #saveRDS(EFE1,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/EFE1_adb_raw_121923.rds")
            #saveRDS(EFE2,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/EFE2_adb_raw_121923.rds")
            #saveRDS(EFE3,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/EFE3_adb_raw_121923.rds")
            #saveRDS(CTRL1,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/Ctrl1_adb_raw_121923.rds")
            #saveRDS(CTRL2,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/Ctrl2_adb_raw_121923.rds")
            #saveRDS(CTRL3,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/Ctrl3_adb_raw_121923.rds")
            #saveRDS(Y1,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/Y1_adb_raw_121923.rds")
            #saveRDS(Y2,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/Y2_adb_raw_121923.rds")
            #saveRDS(Y3,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/Y3_adb_raw_121923.rds")
            #saveRDS(F1,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/F1_adb_raw_121923.rds")
            #saveRDS(F2,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/F2_adb_raw_121923.rds")
            #saveRDS(F3,file="/Users/yangyu/Desktop/Harvard_ChenLab/EP/Intermediates/rna_only/inte_12samp/F3_adb_raw_121923.rds")
            ...
            C4="Fibroblast"  #                
            C5="Pericyte"  ###                     
            C6="Fibroblast"  # Macrophage                   
            C7="EC"  # Fibroblast Cardiomyocyte                    
            C8="EC-Card"  #            
            C9="Macrophage"    #      
            C10="Cardiomyocyte" #                      
            C11="SMC"  #! Erythroid_like                 
            C12="Cardiomyocyte" #  Cardiomyocyte    {PVT1; MTHFD1L}      dt.mg_mkrs[cluster==12][gene%in% dt.mg_mkrs[,list(n=.N),list(gene)][n==1]$gene]          
            C13="EC"  #!  Pericyte                  
            C14="EC"  #       
            C15="Cardiomyocyte"  # Cardiomyocyte       
            C16="EndoC" # EC                    
            C17="Macrophage"   # EC               
            C18="Fibroblast"   #  Pericyte
            C19="Cardiomyocyte"  #                 
            ...
            young_se1@meta.data$Cell_Type[young_se1@meta.data$cell_type %in% c("EC") & young_se1@meta.data$seurat_clusters %in% c("7")] <- "EC_E3"
            young_se1@meta.data$Cell_Type[young_se1@meta.data$cell_type %in% c("EC-Card")] <- "EC_E1"
